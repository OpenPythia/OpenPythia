...
public class FileResourceUtility {
    ...
    private static FileResourceUtility privateInstance = new FileResourceUtility();
    ...
    private static String getStringFromFileSystem(String resourceIdentifier) {
        StringBuffer result = new StringBuffer();
        try {
            String tt = privateInstance.getHome();
            File in = new File(tt + resourceIdentifier);
    ...
    public static String getStringFromResource(String resourceIdentifier) {
        if (isRunningFromJar()) {
            return getStringFromJar(resourceIdentifier);
        } else {
            return getStringFromFileSystem(resourceIdentifier);
        }
    }

    public static String getVersion() {
        // The version resists in folder META-INF, file Version.txt.
        // The content of this file is automatically filled by Maven.
        return getStringFromResource("META-INF/Version.txt");
    }
}
